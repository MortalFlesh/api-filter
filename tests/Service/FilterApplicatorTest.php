    ...
    public function provideFilter(): array
    {
        ...
        return [
            ...
            'sql - function' => [
                ...
                'SELECT * FROM table WHERE public = 1',
                'SELECT * FROM table WHERE public = 1 AND firstName = :firstName_fun AND surname = :surname_fun',
            ...
            'queryBuilder - function' => [
                ...
                $this->setUpQueryBuilder(),
                $this->setUpQueryBuilder()->andWhere('t.firstName = :firstName_fun')->andWhere('t.surname = :surname_fun'),
                ['firstName_fun' => 'Jon', 'surname_fun' => 'Snow'],
                [
                    ['fullName', ['firstName', 'surname']],
                ],
    ...
    public function provideFilters(): array
    {
        ...
        return [
            ...
            'sql - eq + in + function' => [
                ...
                'AND firstName = :firstName_fun AND surname = :surname_fun',
                [
                    'allowed_eq' => 'true',
                    'color_in_0' => 'red',
                    'color_in_1' => 'blue',
            ...
            'queryBuilder - eq + in + function' => [
                ...
                $this->setUpQueryBuilder()
                    ...
                    ->andWhere('t.firstName = :firstName_fun')
                    ->andWhere('t.surname = :surname_fun'),
                [
                    'allowed_eq' => 'true',
                    'color_in' => ['red', 'blue'],
                    'firstName_fun' => 'Jon',
